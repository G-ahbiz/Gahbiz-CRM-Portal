...
export class OrderDetails {
  ...
  getCurrentCustomer() {
    ...
    if (this.currentCustomerId) {
      this.currentCustomer = this.customersDetails.find(
  ...
  getCurrentClientPayment() {
    this.currentClientPayment = this.clientPayments.find(
      (payment) => payment.clientId === this.currentCustomerId
    );
  }
  ...
  getServicesHistory() {
    this.servicesHistory = this.allOrders.filter(
      (order) => order.clientId === this.currentCustomerId
    );
    this.currentServiceData = this.servicesData.find(
      (service) => service.id === this.currentOrder?.serviceID
    );
