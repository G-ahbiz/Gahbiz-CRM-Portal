...
export class AllData {
  ...
  leadsTabelData: LeadsInterface[] = [
    { id: 1, name: 'john smith', service: 'Service 1', source: 'Source 1', status: 'Status 1', assignedTo: 'Assigned To 1', value: '100', createdDate: '2025-11-01' },
    { id: 2, name: 'jane doe', service: 'Service 2', source: 'Source 2', status: 'Status 2', assignedTo: 'Assigned To 2', value: '200', createdDate: '2025-11-02' },
    { id: 3, name: 'jill doe', service: 'Service 3', source: 'Source 3', status: 'Status 3', assignedTo: 'Assigned To 3', value: '300', createdDate: '2025-11-03' },
    { id: 4, name: 'david rodriguez', service: 'Service 4', source: 'Source 4', status: 'Status 4', assignedTo: 'Assigned To 4', value: '400', createdDate: '2025-11-04' },
    { id: 5, name: 'emily johnson', service: 'Service 5', source: 'Source 5', status: 'Status 5', assignedTo: 'Assigned To 5', value: '500', createdDate: '2025-11-05' },
    { id: 6, name: 'michael brown', service: 'Service 6', source: 'Source 6', status: 'Status 6', assignedTo: 'Assigned To 6', value: '600', createdDate: '2025-11-06' },
    { id: 7, name: 'olivia davis', service: 'Service 7', source: 'Source 7', status: 'Status 7', assignedTo: 'Assigned To 7', value: '700', createdDate: '2025-11-07' },
    { id: 8, name: 'olivia davis', service: 'Service 8', source: 'Source 8', status: 'Status 8', assignedTo: 'Assigned To 8', value: '800', createdDate: '2025-11-08' },
  ]
